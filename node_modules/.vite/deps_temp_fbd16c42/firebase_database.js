...
var RepoInfo = (
  /** @class */
  function() {
    function RepoInfo2(host, secure, namespace, webSocketOnly, persistenceKey, includeNamespaceInQueryParams) {
...
var RepoManager = (
  ...
  function() {
    ...
    RepoManager2.prototype.databaseFromApp = function(app, authProvider, url) {
      ...
      var authTokenProvider = CONSTANTS.NODE_ADMIN && isEmulator ? new EmulatorAdminTokenProvider() : new FirebaseAuthTokenProvider(app, authProvider);

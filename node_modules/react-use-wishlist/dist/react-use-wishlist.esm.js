...
var WishlistContext = /*#__PURE__*/createContext(initialState);
...
var WishlistProvider = function WishlistProvider(_ref) {
  ...
  var _React$useReducer = useReducer(reducer, JSON.parse(savedWishlist)),
...
export { WishlistProvider, createWishlistIdentifier, initialState, useWishlist };
//# sourceMappingURL=react-use-wishlist.esm.js.map
